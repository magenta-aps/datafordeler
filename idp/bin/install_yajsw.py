...
def install_yajsw():
    download(
        ...
        "/project/yajsw/yajsw/yajsw-stable-11.11/" +
        "yajsw-stable-11.11.zip"
    )

    ZIP_FILE = os.path.join(BASE_DIR, "yajsw-stable-11.11.zip")

    zip_archive = zipfile.ZipFile(ZIP_FILE, 'r', allowZip64=True)

    print "Unpacking yajsw-stable-11.11.zip"
    zip_archive.extractall(path=BASE_DIR)

    os.rename(
        os.path.join(BASE_DIR, "yajsw-stable-11.11"),
