...
public class DatabaseTest {
    ...
    public void testGetAllEntities() throws DataFordelerException {
        ...
        try {
            ...
            Assertions.assertEquals(1, results1.size());
            Assertions.assertEquals(uuid1, results1.get(0).getUUID());
            ...
            Assertions.assertEquals(uuid1, results2.get(0).getUUID());
            ...
            Assertions.assertEquals(uuid1, results3.get(0).getUUID());
            ...
            Assertions.assertEquals(1, results5.size());
            Assertions.assertEquals(uuid1, results5.get(0).getUUID());
            ...
            Assertions.assertEquals(1, results6.size());
            Assertions.assertEquals(uuid1, results6.get(0).getUUID());
            ...
            Assertions.assertEquals(1, results9.size());
            Assertions.assertEquals(uuid1, results9.get(0).getUUID());
            ...
            Assertions.assertEquals(0, results10.size());
            ...
            Assertions.assertEquals(1, results11.size());
            ...
            Assertions.assertEquals(1, results12.size());
        } finally {
            session.close();
        }
    }
