...
public class UserTest {
    ...
    public void testUnconfiguredDatabase() throws InvalidTokenException {
        ...
        doReturn(
                Arrays.asList("ReadDemoService")
        )
        .when(userQueryManager)
        .getSystemRoleNamesByUserProfileId(TEST_USERPROFILE_ID);
        doReturn(
                Arrays.asList(
        ...
        .when(userQueryManager)
        .getAreaRestrictionsByUserProfileId(TEST_USERPROFILE_ID);
