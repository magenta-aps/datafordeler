...
public class ConfigurationSessionManager extends SessionManager {
    ...
    protected Properties hibernateProperties() {
        ...
        hibernateProperties.setProperty("hibernate.connection.username", System.getenv("SECONDARY_DATABASE_USERNAME"));
        hibernateProperties.setProperty("hibernate.connection.password", System.getenv("SECONDARY_DATABASE_PASSWORD"));
