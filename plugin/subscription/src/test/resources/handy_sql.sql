...
SELECT *
FROM dafotestdb007.[dbo].[subscription_subscriber] subscriber
	JOIN dafotestdb007.[dbo].[subscription_dataevent] subscription
ON (
...
SELECT *
FROM dafotestdb007.[dbo].[subscription_subscriber] subscriber
	JOIN dafotestdb007.[dbo].[subscription_cpr_list] cprList
ON (
