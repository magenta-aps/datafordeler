...
//        ),
        @Index(
                name = GeoPlugin.DEBUG_TABLE_PREFIX + GeoRoadEntity.TABLE_NAME + GeoRoadEntity.DB_FIELD_DAFO_UPDATED+"_new",
                columnList = GeoRoadEntity.DB_FIELD_DAFO_UPDATED+"_new"
        ),
})
