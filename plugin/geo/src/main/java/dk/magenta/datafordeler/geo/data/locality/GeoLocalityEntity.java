...
//        ),
        @Index(
                name = GeoPlugin.DEBUG_TABLE_PREFIX + GeoLocalityEntity.TABLE_NAME + GeoLocalityEntity.DB_FIELD_DAFO_UPDATED+"_new",
                columnList = GeoLocalityEntity.DB_FIELD_DAFO_UPDATED+"_new"
        ),
})
