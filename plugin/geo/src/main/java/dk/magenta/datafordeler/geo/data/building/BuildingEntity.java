...
//        ),
        @Index(
                name = GeoPlugin.DEBUG_TABLE_PREFIX + BuildingEntity.TABLE_NAME + BuildingEntity.DB_FIELD_DAFO_UPDATED+"_new",
                columnList = BuildingEntity.DB_FIELD_DAFO_UPDATED+"_new"
        ),
})
