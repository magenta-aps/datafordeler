...
@Table(name = CvrPlugin.DEBUG_TABLE_PREFIX + CompanyYearlyNumbersRecord.TABLE_NAME, indexes = {
        ...
        @Index(name = CvrPlugin.DEBUG_TABLE_PREFIX + CompanyYearlyNumbersRecord.TABLE_NAME + "__" + CvrBitemporalRecord.DB_FIELD_LAST_UPDATED+"_new", columnList = CvrBitemporalRecord.DB_FIELD_LAST_UPDATED+"new"),
