...
public class PersonRecordQuery extends BaseQuery {
    ...
    static {
        ...
        joinHandles.put("personeventTime.GTE", PersonEntity.DB_FIELD_EVENT + BaseQuery.separator + PersonEventDataRecord.DB_FIELD_TIMESTAMP+"New");
        joinHandles.put("personeventTime.LTE", PersonEntity.DB_FIELD_EVENT + BaseQuery.separator + PersonEventDataRecord.DB_FIELD_TIMESTAMP+"New");
        ...
        joinHandles.put("persondataeventTime.GTE", PersonEntity.DB_FIELD_DATAEVENT + BaseQuery.separator + PersonDataEventDataRecord.DB_FIELD_TIMESTAMP+"New");
        joinHandles.put("persondataeventTime.LTE", PersonEntity.DB_FIELD_DATAEVENT + BaseQuery.separator + PersonDataEventDataRecord.DB_FIELD_TIMESTAMP+"New");
    }
