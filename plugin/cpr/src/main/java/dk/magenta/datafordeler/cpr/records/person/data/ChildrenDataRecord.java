...
@Table(name = CprPlugin.DEBUG_TABLE_PREFIX + ChildrenDataRecord.TABLE_NAME, indexes = {
        ...
        @Index(name = CprPlugin.DEBUG_TABLE_PREFIX + ChildrenDataRecord.TABLE_NAME + CprBitemporalRecord.DB_FIELD_REGISTRATION_FROM, columnList = ChildrenDataRecord.DB_FIELD_CHILD_CPR_NUMBER),
