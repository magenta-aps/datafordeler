...
public class CollectiveReportDataService extends PersonStatisticsService {
    ...
    private final Logger log = LogManager.getLogger(CollectiveReportDataService.class.getCanonicalName());

    private static final String reportTemplateLink = "<a>%s - %s</a><br>";
